...
<div class="content">
    ...
    <a href="<?= BASE_URL ?>anggota/create" class="btn-add">
    ...
    <table class="table">
        ...
        <?php if (!empty($data)): ?>
            ...
            <tr>
                ...
                <td>
                    <div class="action-group">
                        ...
                        <a href="<?= BASE_URL ?>anggota/delete/<?= $row['id_anggota'] ?>" onclick="return confirm('Hapus anggota ini?')">
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <tr><td colspan="5" style="text-align:center; padding:15px;">Tidak ada data</td></tr>
        <?php endif; ?>
    </table>
